...
Original file is located at
    https://colab.research.google.com/drive/1yvALpW_GzFJy2aqAiCHRBVTp8PBlVHCD
...
Proses pertama yaitu pengambilan data abstrak dari Twitter menggunakan teknik crawling. Crawling merupakan teknik mengumpulkan data pada sebuah website dengan memasukkan Uniform Resource Locator (URL).
